...
public class Bezier3 extends View {
    ...
    private float mCurrent = 0;//当前已进行的时长
    ...
    private void drawCoordinateSystem(Canvas canvas) {
               ...
               canvas.translate(mCenterX,mCenterY);//将坐标系移动到画布中央
               canvas.scale(1,-1);//翻转y轴
               Paint fuzuPaint=new Paint();
               fuzuPaint.setColor(Color.RED);
               fuzuPaint.setStrokeWidth(5);
               fuzuPaint.setStyle(Paint.Style.STROKE);
               canvas.drawLine(0,-2000,0,2000,fuzuPaint);
               canvas.drawLine(-2000,0,2000,0,fuzuPaint);
               canvas.restore();
    }
}
